...
# Lazy import of app to avoid circular dependency
def __getattr__(name: str):
    """Lazily import the app to avoid circular imports."""
    if name == "app":
        from .command import app  # pylint: disable=import-outside-toplevel
