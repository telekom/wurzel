...
- `PROMETHEUS__GATEWAY`: Prometheus pushgateway URL for metrics (when using prometheus middleware)
- `PROMETHEUS__JOB`: Job name for Prometheus metrics (default: `default-job-name`)
