...
@pytest.mark.mytest
@pytest.mark.parametrize("env_dict,get_embedding_settings", [
    pytest.param({'PREFIX__API': 'https://de.my.example.com'},lambda : _Nested().PREFIX,id="Nested"),
    pytest.param({'API': 'https://de.my.example.com'},lambda : _EmbeddingSettings(),id="Root")
])
