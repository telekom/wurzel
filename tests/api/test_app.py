...
class TestCreateApp:
    ...
    def test_all_expected_routes_registered(self):
        ...
        expected = {
            ...
            "/v1/projects/{project_id}/steps",
            "/v1/projects/{project_id}/steps/{step_path:path}",
            "/v1/projects/{project_id}/packages",
            "/v1/projects/{project_id}/packages/{package_id}",
            "/v1/projects/{project_id}/packages/secrets",
            "/v1/projects/{project_id}/packages/secrets/{secret_name}",
