...
import pytest
from wurzel import PrometheusStepExecutor, TypedStep, Settings, PydanticModel, BaseStepExecutor
...
@pytest.mark.parametrize("env_set", [
    ('MYSTEP__key', 'value'),
    ('MYSTEP', '{"key": "value"}')
])
...
@pytest.mark.parametrize("executor", [
    PrometheusStepExecutor, BaseStepExecutor
]
)
